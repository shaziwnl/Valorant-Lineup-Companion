const videoLinks: any = {
  ...
  Ascent: {
    ...
    Chamber : [],
    Gekko : [],
    Kayo : [{title: "Kayo Ascent Flashdrive BSite Lane Attack", id: 'ixsyw_XWQr0'},
            {title: "Kayo Ascent Flashdrive ASite A Main Attack", id: 'ixsyw_XWQr0'},
            {title: "Kayo Ascent Flashdrive ASite Attack", id: 'ixsyw_XWQr0'},],
    Neon : [],
    Pheonix : [],
    Raze : [],
    Reyna : [],
